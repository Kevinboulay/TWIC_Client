...
@WebServlet(name = "Distance", value = "/")
public class DistanceServlet extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        VilleModel[] villes = this.getVille("http://localhost:8191/ville");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        VilleModel[] ville1 = this.getVille("http://localhost:8191/ville?codePostal="+codeVille1);
        VilleModel[] ville2 = this.getVille("http://localhost:8191/ville?codePostal="+codeVille2);
